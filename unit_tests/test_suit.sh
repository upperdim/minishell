...
$CC $CFLAGS $INCLUDES $LIBRARIES unit_tests/test_parser.c src/parser/parser.c -DTEST=2
./a.out >> logs/result_parser.log
$CC $CFLAGS $INCLUDES $LIBRARIES unit_tests/test_parser.c src/parser/parser.c -DTEST=3
./a.out >> logs/result_parser.log
